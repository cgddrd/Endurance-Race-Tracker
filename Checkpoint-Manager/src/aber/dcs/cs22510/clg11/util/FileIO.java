...
public class FileIO {
    ...
    /**
     * Reads in the contents of specified data files and places the contents
     * into an Arraylist which is then returned, and used to update the internal
    ...
    /**
     * Writes output data to specified files, as these files are shared, file
     * locking has to be used to prevent corruption of data/files.
     *
    ...
    /**
     * Adds a new log message to the "logs.txt" file. Called when a major
    ...
    public boolean addActivityLog(String logMessage) {
        ...
        return writeFile(new File("../files/log.txt"), logOutput);
